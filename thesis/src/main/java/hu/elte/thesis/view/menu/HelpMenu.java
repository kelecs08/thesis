...
public class HelpMenu extends JMenu {
	...
	// private final String stepThree = "2. Or you can transport your blob to a field that is two steps away from your position, not changing the number of
	// blobs you own.";
	// private final String fight = "If you step to a position which direct neighbours are the enemy's puppets, you will overtake them. So your fields will
	// increase.";
	// private final String win = "To win the game, you have to own the most fields on the board or corner your enemy, so they cannot move anymore with either
